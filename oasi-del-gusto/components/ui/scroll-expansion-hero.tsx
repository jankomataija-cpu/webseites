        ...
        <div className='relative w-full flex flex-col items-center min-h-[100dvh]'>
          ...
          >
            <Image
              ...
              onError={(e) => handleImgFallback(e.currentTarget, bgFallbackSrc)}
              priority
            />
                ...
                {mediaType === 'video' ? (
                  ...
                  <div className='relative w-full h-full'>
                    <Image
                      ...
                      className='w-full h-full object-cover rounded-xl'
                      onError={(e) =>
                        handleImgFallback(e.currentTarget, mediaFallbackSrc)
                      }
                    />
                ...
                {logoSrc && (
                  ...
                  >
                    <Image
                      ...
                      width={220}
                      height={220}
                      className='w-36 md:w-52 h-auto drop-shadow-[0_4px_24px_rgba(0,0,0,0.45)]'
                      priority
                    />
                  </motion.div>
                )}
